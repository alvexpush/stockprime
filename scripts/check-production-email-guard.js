...
const environment={...process.env,PORT:String(port),NODE_ENV:"production",EMAIL_PROVIDER:"zoho",ZOHO_CLIENT_ID:"",ZOHO_CLIENT_SECRET:"",ZOHO_REFRESH_TOKEN:"",ZOHO_FROM_EMAIL:"",OTP_SECRET:""};delete environment.RESEND_API_KEY;
...
(async()=>{
  try{
    ...
    console.log("PASS production refuses registration when Zoho/OTP secrets are missing and leaves no orphan account");
